			...
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">
						<i class="fa fa-user-plus fa-lg"></i><span id="stdInfoModalTitle">If you see me smth is wrong yo</span>
					</h4>
				</div>
				...
				<div class="col-lg-6" style="padding-left: 2px">
					<div class="modal-body">
						...
						<div class="form-group" style="padding-bottom: 0px">
							...
							<div class="col-lg-5" style="padding-left: 0px; padding-right: 0px;">
								<div class="form-group">
									...
									<select class="form-control" id="lessonVenue" name="lessonVenue">
										...
										<option value="<?php echo $row['venue_id'];?>" <?php if($row['default_place']=='Y'){ ?> selected="selected"
											<?php } ?>>
							...
							<div class="col-lg-7" style="padding-left: 3px; padding-right: 0px; padding-bottom: 10px">
								<div class="form-group">
									<label>Time</label>
