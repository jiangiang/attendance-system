...
<form id = "billActivationForm" name = "billActivationForm">
    <input type = "hidden" id = "activationID" name = "activationID">
</form>

<form id = "tuitionFeeReceivableForm" name = "tuitionFeeReceivableForm" autocomplete = "off">
                ...
                <div class = "modal-body">
                    ...
                    <div class = "col-lg-6 col-xs-6" style = "padding-left: 0px; padding-right: 2px">
                        <div class = "form-group">
                            ...
                            <input class = "form-control" placeholder = "Payment Date" id = "payment_date" name = "payment_date" required>
                        </div>
                    </div>
                    <div class = "col-lg-6 col-xs-6" style = "padding-left: 0px; padding-right: 2px">
                        <div class = "form-group">
                        ...
                        <div class = "form-group">
                            ...
                            <select class = "form-control" id = "billPackage" name = "billPackage" required>
                                ...
                                <?php foreach ( $package_rows as $row ) { ?>
                                    <option
                                        value = "<?php echo $row[ 'package_id' ]; ?>"><?php echo $row[ 'package_name' ] . "-" . $row[ 'term' ] . "class(es)-RM " . $row[ 'price' ]; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class = "box-header">
                            <div class = "col-md-2 col-xs-2" style = "padding-left:2px;">
                                <div class = "input-group">
                                    <span class = "input-group-addon"><label>Month</label></span>
                                    <select class = "form-control" id = "searchMonth" name = "searchMonth">
                                        ...
                                        <?php for ( $i = 1; $i <= 12; $i++ ) { ?>
                                            <option value = "<?php echo $i ?>" <?php if ( $month == $i ) {
                                                ...
                                                <?php echo date( 'F', strtotime( "First day of December + " . $i . " months" ) ); ?>
                                            </option>
                                        <?php } ?>
                                    </select>
                                </div>
                            ...
                            <div class = "col-md-2 col-xs-2" style = "padding-left:2px;">
                                <div class = "input-group">
                                    ...
                                    <select class = "form-control" id = "billType" name = "billType">
                                        <option value = "" selected = "selected">All</option>
                                        <option value = "N" <?php if ( $proccessed == 'N' ) {
                                            echo "SELECTED";
                                        } ?>>Unproccessed
                                        </option>
                                        <option value = "Y" <?php if ( $proccessed == 'Y' ) {
                                            echo "SELECTED";
                                        } ?>>Processed
                                        </option>
                                    </select>
                            ...
                            <div class = "col-md-3 col-xs-3" style = "padding-left:2px;">
                                <div class = "input-group">
                                    ...
                                    <input class = "form-control" placeholder = "Search by Name" id = "searchName" name = "searchName"
                                           value = "<?php echo $name ?>">
                                </div>
                            </div>
                            <div class = "col-md-3 col-xs-5" style = "padding-left:2px;">
                                <div class = "form-group">
                                    <div class = "btn-group">
                                        ...
                                        <button type = "button" class = "btn btn-success btnTuitionFeeReceivable" id = "btnTuitionFeeReceivable">New Payment
                                        </button>
                                    </div>
                                </div>
                            </div>
