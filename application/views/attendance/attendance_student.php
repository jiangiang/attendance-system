		...
		<div class="modal-dialog" style="margin-top: 2%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="submit" class="btn btn-primary" disabled="disabled" id="btnSubmitReplace">Submit Replacement/ Overdue</button>
				</div>
			</div>
		</div>
	</div>
...
<div class="content-wrapper">
	<section class="content-header">
		<h1>Student Attendance - <?php echo date('Y-m-d l, ', strtotime($currDate)) . date('g:i:s A', strtotime($next_slot_time)) ?></h1>
	</section>
									...
									<div class="form-group">
										<select id="schedule_id" name="schedule_id" class="form-control">
											...
											<option value="<?php echo $row['schedule_id']?>" <?php
												if ($row['schedule_id'] == $schedule_id) {echo "selected='selected'";}
						...
						<div class="box-body">
							<table class="table table-bordered table-hover" id="tblActiveStudent">
								...
								<tr>
										...
										<td><span <?php if($row['lesson_left'] <=0){?> style="color: red" <?php } ?> ><?php echo $row['lesson_left']?></span></td>
