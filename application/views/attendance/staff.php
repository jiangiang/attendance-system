			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						<label>Full time employee will not show here.</label>
					</div>
					<div class="form-group">
					...
					<div class="col-lg-5" style="padding-left: 0px; padding-right: 2px">
						<div class="form-group">
							<label>Date</label> <input class="form-control" placeholder="Session Date." id="sessionDate"
								name="sessionDate" readonly="readonly" required="required" autocomplete="off">
						</div>
					</div>
					<div class="col-lg-7" style="padding-left: 0px; padding-right: 2px">
						<div class="form-group">
